...
;;-----------------------------------------------------------------------------
       ...
       (modeline ((t (:foreground "#bbb"))))
       (mode-line-inactive ((t (:foreground "#444"))))
...
;     (org-done ((t (:foreground "#55ff55")))) ; Commented out because green is too bright
     (org-done ((t (:foreground "#555" :weight bold))))
