(defun color-theme-dec ()
  "Color theme by David O'Toole, created 2006-04-16."
  (interactive)
  (color-theme-install
   '(color-theme-dec
     ...
     (default ((t (:stipple nil :background "lightskyblue" :foreground "royalblue4" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 98 :width normal :family "misc-fixed"))))
     ...
     (font-lock-builtin-face ((t (:bold t :foreground "steelblue3" :weight bold))))
     (font-lock-comment-delimiter-face ((t (:foreground "dodgerblue3"  ))))
     ...
     (font-lock-function-name-face ((t (:italic t :bold t :foreground "lightgoldenrod1" :slant italic :weight bold))))
     (font-lock-interface-def-face ((t (nil))))
     (font-lock-keyword-face ((t (:bold t :foreground "white" :weight bold))))
     ...
     (font-lock-regexp-grouping-backslash ((t (:foreground "steelblue"))))
     (font-lock-regexp-grouping-construct ((t (:foreground "steelblue"))))
     (font-lock-string-face ((t (:foreground "darkskyblue2"))))
     ...
     (fringe ((t (:background "skyblue3" :foreground "white"))))
     ...
     (mode-line ((t (:background "skyblue4" :foreground "lightcyan" :box (:line-width -1 :style released-button)))))
     (mode-line-highlight ((t (nil))))
     (mode-line-inactive ((t (:background "skyblue3" :foreground "lightcyan" :box (:line-width -1 :style released-button)))))
     (modeline-buffer-id ((t (:foreground "white" :slant normal :weight bold :bold t :width normal ))))
     ...
     (muse-header-1 ((t (:bold t :family "helv" :weight bold :height 1.4))))
     (muse-header-2 ((t (:bold t :family "helv" :weight bold :height 1.3))))
     (muse-header-3 ((t (:bold t :family "helv" :weight bold :height 1.2))))
     (muse-header-4 ((t (:bold t :family "helv" :weight bold :height 1.1))))
     (muse-header-5 ((t (:bold t :family "helv" :weight bold :height 1.0))))
     (muse-link-face ((t (:bold t :weight bold :foreground "cyan"))))
     ...
     (org-done ((t (:bold t :weight bold :foreground "PaleGreen"))))
     ...
     (show-paren-match ((t (:bold t :background "steelblue4" :foreground "white" :weight bold))))
