(defun color-theme-executif ()
  ...
  (color-theme-install
   '(color-theme-executif
     ...
     (default ((t (:stipple nil :background "Grey15" :foreground "darkkhaki" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 98 :width normal :family "misc-fixed"))))
     ...
     (font-lock-comment-delimiter-face ((t (:foreground "burlywood3" ))))
     (font-lock-comment-face ((t (:foreground "burlywood3"))))
     ...
     (font-lock-function-name-face ((t (:bold t :foreground "burlywood4" :weight bold))))
     (font-lock-interface-def-face ((t (nil))))
     (font-lock-keyword ((t (nil))))
     (font-lock-keyword-face ((t (:bold t :foreground "burlywood3" :weight bold))))
     ...
     (fringe ((t (:background "burlywood2"))))
     ...
     (mode-line ((t (:background "darkgoldenrod" :foreground "white" :box (:line-width -1 :color "gold")))))
     (mode-line-highlight ((t (nil))))
     (mode-line-inactive ((t (:background "gray20" :foreground "gray70" :box (:line-width -1 :color "gray40")))))
