(defun color-theme-gouache-bright ()
  "Color theme by David O'Toole, created 2006-04-16."
  (interactive)
  (color-theme-install
   '(color-theme-gouache-bright
     ...
     (default ((t (:stipple nil :background "saddlebrown" :foreground "orange" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 98 :width normal :family "misc-fixed"))))
     ...
     (cell-wiki-face ((t (:foreground "white" :background "forestgreen" ))))
     ...
     (eev-glyph-face-red ((t (:bold t :weight bold :foreground "yellow" :background "red" ))))
     ...
     (info-xref ((t (:bold t :weight bold :foreground "gold"))))
     ...
     (org-done ((t (:bold t :weight bold :foreground "yellow" :background "forestgreen"))))
     (org-formula ((t (:foreground "chocolate1"))))
     (org-headline-done ((t (:foreground "palegreen"))))
     (org-hide ((t (:foreground "black"))))
     (org-level-1 ((t (:foreground "Cyan" :bold t :weight bold))))
     (org-level-2 ((t (:foreground "khaki" :bold t :weight bold))))
     (org-level-3 ((t (:foreground "palegreen" :bold t :weight bold))))
...
;     (rcirc-server-face ((t (nil))))
     ...
     (rcirc-dim-nick ((t ( :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "orange" :background "saddlebrown" :stipple nil :height 98))))
     (rcirc-mode-line-nick ((t (:bold t :weight bold :color "red"))))
     ...
     (rcirc-timestamp ((t (:family "misc-fixed" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "orange" :background "saddlebrown" :stipple nil :height 98))))
