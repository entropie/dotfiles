(defun color-theme-hyper-frame ()
  "Color theme by David O'Toole, created 2007-01-05."
  (interactive)
  (color-theme-install
   '(color-theme-hyper-frame
     ((background-color . "OliveDrab4")
      (foreground-color . "OliveDrab1")
     ...
     (default ((t (:stipple nil :background "OliveDrab4" :foreground "OliveDrab1" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 116 :width semi-condensed :family "mplus-fxd"))))
     ...
     (eev-glyph-face-red ((t (:foreground "red" :bold t :weight bold))))
     ...
     (emms-pbi-song-face ((t (:background "royalblue4" :foreground "royalblue"))))
     ...
     (font-lock-comment-delimiter-face ((t (:foreground "OliveDrab2"))))
     (font-lock-comment-face ((t (:foreground "OliveDrab3"))))
     (font-lock-constant-face ((t (:foreground "Aquamarine" ))))
     (font-lock-doc-face ((t (:foreground "greenyellow"))))
     ...
     (fringe ((t (:background "#608014"))))

     (linkd-generic-face ((t (:foreground "aquamarine1"))))
     (linkd-node-face ((t (:foreground "aquamarine1" :background "aquamarine4" :underline "yellow"))))
     (linkd-to-face ((t (:foreground "aquamarine2" :background "aquamarine4" :underline "yellow"))))
     (linkd-other-face ((t (:foreground "aquamarine3" :background "aquamarine4" :underline "yellow"))))
...
;;      (linkd-generic-face ((t (:foreground "turquoise1" :background "turquoise4"))))
;;      (linkd-node-face ((t (:foreground "turquoise1" :background "turquoise4"))))
;;      (linkd-to-face ((t (:foreground "turquoise2" :background "turquoise4"))))
;;      (linkd-other-face ((t (:foreground "turquoise3" :background "turquoise4"))))
     ...
     (golisp-anchor-face ((t (nil))))
     (golisp-bullet-face ((t (nil))))
     (golisp-defxref-name-face ((t (nil))))
     (golisp-xref-face ((t (nil))))
     ...
     (highlight ((t (:background "violetred3" :foreground "white"))))
     ...
     (mode-line ((t (:background "OliveDrab3" :foreground "olivedrab4" :box (:color "white" :line-width 1 :style none)))))
     (mode-line-buffer-id ((t (:foreground "white" ))))
     (mode-line-highlight ((t (nil))))
     (mode-line-inactive ((t (:background "OliveDrab4" :foreground "OliveDrab2" :box (:line-width 1 :style none)))))
     ...
     (org-done ((t (:bold t :foreground "yellow" :background "forestgreen" :weight bold))))
     ...
     (org-scheduled-previously ((t (:foreground "chocolate"))))
     ...
     (org-todo ((t (:bold t :foreground "Yellow" :background "red" :weight bold))))
     ...
     (rcirc-nick-in-message-face ((t (:foreground "yellow"))))
     (rcirc-nick-in-message-full-line ((t (:foreground "palegreen"))))
     (rcirc-other-nick ((t (:foreground "yellow"))))
     (rcirc-other-nick-face ((t (:bold t :foreground "lightskyblue" :weight bold))))
     (rcirc-prompt ((t (:foreground "cyan1"))))
     (rcirc-server ((t (:foreground "paleturquoise2"))))
     (rcirc-server-face ((t (nil))))
     (rcirc-server-prefix ((t (:foreground "paleturquoise1"))))
     (rcirc-timestamp ((t (:stipple nil  :foreground "olivedrab3"))))
     ...
     (region ((t (:background "palevioletred4" :foreground "cyan"))))
     (right-margin ((t (nil))))
     ...
     (show-paren-mismatch ((t (:bold t :background "RosyBrown" :foreground "white" :weight bold))))
     ...
     (w3m-anchor-face ((t (:foreground "yellow" :underline t))))
     (w3m-arrived-anchor-face ((t (:foreground "yellow" :underline t))))
     (w3m-bold-face ((t (nil))))
     ...
     (widget-button ((t (:foreground "white" :background "olivedrab3" :box (:line-width 1 :style released-button)))))
     (widget-button-pressed ((t (:foreground "white" :background "orchid4"))))
     (widget-documentation ((t (:foreground "lime green"))))
     (widget-field ((t (:background "violetred3" :foreground "white"))))
     (widget-inactive ((t (:foreground "darkbrown"))))
