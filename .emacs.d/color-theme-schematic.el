(defun color-theme-schematic ()
  "Color theme by David O'Toole, created 2006-10-15."
  (interactive)
  (color-theme-install
   '(color-theme-schematic
     ...
     (default ((t (:stipple nil :background "deepskyblue4" :foreground "lightcyan" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 125 :width normal :family "misc-fixed"))))
     ...
     (erc-current-nick-face ((t ( :foreground "lightpink" ))))
     ...
     (erc-nick-msg ((t (nil))))
     (erc-nick-msg-face ((t (:bold t :foreground "cyan" :weight bold))))
     (erc-notice ((t (nil))))
     (erc-notice-face ((t (:foreground "cyan"))))
     (erc-pal ((t (nil))))
     ...
     (font-lock-warning-face ((t (:foreground "cyan" :underline "red"))))
     (fringe ((t (:background "#005978" :foreground "cyan"))))
     (gnus-button ((t (nil))))
     ...
     (header-line ((t (:background "#005071" :foreground "cyan"))))
     ...
     (mode-line ((t (:background "red" :foreground "yellow"))))
     (mode-line-buffer-id ((t ( :foreground "white"))))
     (mode-line-highlight ((t (nil))))
     (mode-line-inactive ((t (:background "#005978" :foreground "cyan" ))))
     (modeline-mousable ((t (:background "white" :foreground "DeepSkyBlue"))))
     ...
     (headline-face ((t (:foreground "light blue" :underline "light blue"))))
     (org-headline-done ((t (:foreground "palegreen"))))
     (todo-comment-face ((t (:background "red" :foreground "yellow"))))
     (todo-comment-text-face ((t (:underline "cyan"))))
     (org-hide ((t (:foreground "deepskyblue3"))))
     ...
     (region ((t (:background "seagreen" :foreground "yellow"))))
     (right-margin ((t (nil))))
     ...
     (scroll-bar ((t (:background "gray30" :foreground "gray55" :box nil))))
     ...
     (show-paren-mismatch ((t (:bold t :background "magenta" :foreground "yellow" :weight bold))))
