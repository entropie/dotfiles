(defun color-theme-cl-frame ()
  ...
  (color-theme-install
   '(color-theme-cl-frame
     ...
     (default ((t (:stipple nil :background "gray31" :foreground "gray90" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 113 :width normal :family "misc-fixed"))))
     ...
     (font-lock-comment-delimiter-face ((t (:background "gray27" :foreground "gray60"))))
     (font-lock-comment-face ((t (:background "gray29" :foreground "white"))))
     ...
     (font-lock-function-name-face ((t (:bold t :foreground "gray60" :weight bold))))
     (font-lock-interface-def-face ((t (nil))))
     (font-lock-keyword-face ((t (:bold t :foreground "Gold2" :weight bold))))
     ...
     (font-lock-type-face ((t (:bold t :foreground "gray60" :underline t :weight bold))))
     (font-lock-variable-name-face ((t (:bold t :foreground "AntiqueWhite4" :weight bold))))
     ...
     (rcirc-my-nick-face ((t (:bold t :foreground "goldenrod" :weight bold))))
     (rcirc-nick-in-message-face ((t (:foreground "greenyellow"))))
     (rcirc-other-nick-face ((t (:bold t :foreground "gold" :weight bold))))
