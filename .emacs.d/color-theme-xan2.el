(defun color-theme-xan2 ()
  ...
  (color-theme-install
   '(color-theme-xan2
     ...
     (default ((t (:stipple nil :background "#233b5a" :foreground "#fff8dc" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 98 :width normal :family "misc-fixed"))))
     ...
     (font-lock-comment-delimiter-face ((t (:foreground "mediumaquamarine"))))
     ...
     (mode-line ((t (:background "dodgerblue2" :foreground "lightcyan" :box (:line-width -1 :style released-button)))))
     (mode-line-highlight ((t (nil))))
     (mode-line-inactive ((t (:background "dodgerblue4" :foreground "lightcyan" :box (:line-width -1 :style released-button)))))
